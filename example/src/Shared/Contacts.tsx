    ...
    <Animated.FlatList
      ...
      ListHeaderComponent={
        ...
        <View
          style={{
            flex: 1, // Doesn't work
            // height: '100%', // Fills the screen but can't scroll
          }}
        >
...
export const AnimatedNestedPopulatedContacts = React.forwardRef<
  any,
  React.PropsWithoutRef<CollapsibleScenePropsAndRef>
>((props, ref) => {
  const [isRefreshing, startRefreshing] = useRefresh();
...
export const AnimatedNonNestedPopulatedContacts = () => {
  const scenePropsAndRef = useCollapsibleScene('contactsNonNestedPopulated');
