 ...
 */
const SectionListMemo = React.memo(React.forwardRef((props, passRef) => {
    return (React.createElement(AnimatedSectionList
    // @ts-expect-error reanimated types are broken on ref
    , Object.assign({ 
        // @ts-expect-error reanimated types are broken on ref
        ref: passRef }, props)));
}));
function SectionListImpl({ contentContainerStyle, style, onContentSizeChange, refreshControl, ...rest }, passRef) {
 ...
 */
export const SectionList = React.forwardRef(SectionListImpl);
