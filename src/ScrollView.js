 ...
 */
const ScrollViewMemo = React.memo(React.forwardRef((props, passRef) => {
 ...
 */
export const ScrollView = React.forwardRef(({ contentContainerStyle, style, onContentSizeChange, children, refreshControl, ...rest }, passRef) => {
